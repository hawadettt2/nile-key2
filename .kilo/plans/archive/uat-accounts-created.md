...
|----------|------|-------|--------|
| `uat_owner` | `owner` | uat_owner@example.com | âœ… Created |
| `uat_manager` | `manager` | uat_manager@example.com | âœ… Created |
| `uat_sales` | `sales` | uat_sales@example.com | âœ… Created |

## Login Verification

| Username | Role | Password | Login Result |
|----------|------|----------|--------------|
| `uat_owner` | `owner` | 6-digit numeric | âœ… SUCCESS |
| `uat_manager` | `manager` | 6-digit numeric | âœ… SUCCESS |
| `uat_sales` | `sales` | 6-digit numeric | âœ… SUCCESS |
