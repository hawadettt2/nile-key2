# Architecture Consolidation Plan â€” Documentation SSOT
...
The project currently has 50+ Markdown documents across root, `docs/`, `docs/architecture/`, and `.kilo/plans/`. Multiple documents declare themselves authoritative, contain overlapping content, or are superseded. Despite `PLAN.md` declaring itself the "Master Roadmap v2.1 â€” Single Source of Truth" in over 100 cross-references, the actual document landscape violates SSOT principles through duplication, drift, and unclear authority chains.
...
| Document | Rationale |
|----------|-----------|
| **`PLAN.md`** | Already declared "Master Roadmap v2.1 â€” Single Source of Truth" in 100+ references. Contains architecture, execution rules, work package registry, and governance. Restructure in place. |
...
| 2 | `docs/architecture/WORK_PACKAGE_PLAN.md` | Detailed WP lifecycle breakdowns (1129 lines) | Section 15 (Work Package Registry) â€” as expanded detail |
...
| 5 | `\.kilo/plans/archive/wp42-owner-acceptance-certificate\.md` | UAT evidence; append after closure |
...
| 21 | `\.kilo/plans/archive/wp42-owner-acceptance-certificate\.md` | Superseded |
...
â”œâ”€â”€ Section 2: Executive Architecture Vision
â”‚   (absorbed from .kilo/plans/earp-001/executive-architecture-vision.md)
â”œâ”€â”€ Section 3: Product Identity & Platform Definition
â”œâ”€â”€ Section 4: System Architecture
â”‚   â”œâ”€â”€ 4.1 Layers
â”‚   â”œâ”€â”€ 4.2 Bounded Contexts
â”‚   â”œâ”€â”€ 4.3 Boundaries & Invariants
â”‚   â””â”€â”€ 4.4 ERP Isolation
â”œâ”€â”€ Section 5: Naming Policy & Terminology
â”‚   (absorbed from EAD Decision 9.1/9.2/9.3)
â”œâ”€â”€ Section 6: Work Package Registry
â”‚   â”œâ”€â”€ 6.1 WP Summary Table
â”‚   â”œâ”€â”€ 6.2 WP-01 through WP-42 Detail
â”‚   â””â”€â”€ 6.3 Dependencies & Sequencing
â”‚   (expanded from docs/architecture/WORK_PACKAGE_PLAN.md)
â”œâ”€â”€ Section 7: Current Status Dashboard
â”‚   (absorbed from CURRENT_STATUS.md summary tables)
â”œâ”€â”€ Section 8: Execution Rules & Governance
â”‚   (absorbed from PROJECT_RULES.md, PROJECT_EXECUTION_RULES.md, WORKFLOW.md, INSTRUCTIONS.md)
â”œâ”€â”€ Section 9: Architecture Principles
â”‚   (absorbed from ARCHITECTURE_CHARTER.md)
â”œâ”€â”€ Section 10: Baseline & State
â”‚   (absorbed from PROJECT_BASELINE.md, FINAL_BASELINE.md, BASELINE_SUMMARY.md, PROJECT_BASELINE_AFTER_WP21.md)
â”œâ”€â”€ Section 11: Repository Intelligence
â”‚   (absorbed from docs/architecture/REPOSITORY_INTELLIGENCE.md)
â”œâ”€â”€ Section 12: Deployment & Operations
â”‚   (absorbed from DEPLOYMENT.md)
â”œâ”€â”€ Section 13: Technical Debt
â”‚   (absorbed from TECH_DEBT.md)
â”œâ”€â”€ Section 14: Changelog Summary
â”‚   (index only; full detail remains in CHANGELOG.md)
â”œâ”€â”€ Section 15: Decision Index
â”‚   (links to EDs, ADRs, EADs, EARP-001 package)
â”œâ”€â”€ Section 16: Contract Index
â”‚   (links to contracts)
â”œâ”€â”€ Section 17: Appendix References
â”‚   (links to appendices in docs/appendices/)
â””â”€â”€ Section 18: Document Authority Map
...
```
F:\nilekey\nile-key-project\nile-key2\
â”œâ”€â”€ README.md                          # Project overview, quickstart, SSOT link
â”œâ”€â”€ PLAN.md                            # MASTER â€” Single Source of Truth
â”œâ”€â”€ CURRENT_STATUS.md                  # Standalone â€” live status
â”œâ”€â”€ TECH_DEBT.md                       # Standalone â€” debt register
â”œâ”€â”€ CHANGELOG.md                       # Standalone â€” version history
â”œâ”€â”€ ARCHITECTURE_CHARTER.md            # ARCHIVED â†’ .kilo/plans/archive/
â”œâ”€â”€ PROJECT_BASELINE_AFTER_WP21.md     # MERGED into PLAN.md, then archived
â”œâ”€â”€ WORKFLOW.md                        # MERGED into PLAN.md, then archived
â”œâ”€â”€ INSTRUCTIONS.md                    # MERGED into PLAN.md, then archived
â”œâ”€â”€ PROJECT_RULES.md                   # MERGED into PLAN.md, then archived
â”œâ”€â”€ DEPLOYMENT.md                      # MERGED into PLAN.md, then archived
â”œâ”€â”€ WP-15_FINAL_VERIFICATION.md        # ARCHIVED
â”œâ”€â”€ WP21_M5_Stage*.md                  # ARCHIVED
â”œâ”€â”€ docs/
â”‚   â”œâ”€â”€ architecture/
â”‚   â”‚   â”œâ”€â”€ ENGINEERING_MEMORY.md      # Standalone â€” Decision Log
â”‚   â”‚   â”œâ”€â”€ WORK_PACKAGE_PLAN.md       # MERGED into PLAN.md, then archived
â”‚   â”‚   â”œâ”€â”€ PROJECT_BASELINE.md        # MERGED into PLAN.md, then archived
â”‚   â”‚   â”œâ”€â”€ FINAL_BASELINE.md          # MERGED into PLAN.md, then archived
â”‚   â”‚   â”œâ”€â”€ BASELINE_SUMMARY.md        # MERGED into PLAN.md, then archived
â”‚   â”‚   â”œâ”€â”€ REPOSITORY_INTELLIGENCE.md # MERGED into PLAN.md, then archived
â”‚   â”‚   â”œâ”€â”€ WP-02_COMPLETION_REPORT.md # APPENDIX
â”‚   â”‚   â””â”€â”€ ADR-0001-shipments-legacy-columns.md # Standalone
â”‚   â”œâ”€â”€ appendices/
â”‚   â”‚   â”œâ”€â”€ UAT_CHECKLIST.md           # Appendix
â”‚   â”‚   â”œâ”€â”€ OV-001-stage-6-ux-manual.md # Appendix
â”‚   â”‚   â”œâ”€â”€ wp42-uat-runbook.md        # Appendix
â”‚   â”‚   â”œâ”€â”€ wp42-uat-session-schedule.md # Appendix
â”‚   â”‚   â”œâ”€â”€ wp42-owner-acceptance-certificate.md # Appendix
â”‚   â”‚   â”œâ”€â”€ wp33e-final-roadmap-verification.md # Appendix
â”‚   â”‚   â”œâ”€â”€ wp40f-final-closure-and-baseline-verification.md # Appendix
â”‚   â”‚   â””â”€â”€ wp41-documentation-verification-report.md # Appendix
â”‚   â”œâ”€â”€ UAT_CHECKLIST.md               # MOVED to appendices/
â”‚   â”œâ”€â”€ PROJECT_EXECUTION_RULES.md     # MERGED into PLAN.md, then archived
â”‚   â”œâ”€â”€ OV-001-stage-8-final-review.md # ARCHIVED
â”‚   â””â”€â”€ OV-001-stage-6-ux-manual.md    # MOVED to appendices/
â””â”€â”€ .kilo/
    â””â”€â”€ plans/
        â”œâ”€â”€ earp-001/                   # Standalone governance package
        â”œâ”€â”€ archive/                    # HISTORICAL ARCHIVE
        â”‚   â”œâ”€â”€ 1784*-prefixed-files/
        â”‚   â”œâ”€â”€ wp*-execution-plans/
        â”‚   â”œâ”€â”€ wp*-verification-reports/
        â”‚   â”œâ”€â”€ wp*-audit-reports/
        â”‚   â””â”€â”€ wp42-uat-evidence/
        â”œâ”€â”€ ED-*.md                     # Standalone references
        â”œâ”€â”€ *-spec.md                   # Standalone references
        â”œâ”€â”€ *-contract.md               # Standalone references
        â””â”€â”€ BA-*.md, ADR-*.md           # Standalone references
```
...
| `\.kilo/plans/archive/wp42-owner-acceptance-certificate\.md` | `docs/appendices/wp42-owner-acceptance-certificate.md` | Move |
