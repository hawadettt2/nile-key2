...
- معايير القبول:
  - [ ] نماذج Pydantic للفاتورة الإلكترونية مطابقة لـ ETA Schema v1.0
  - [ ] نماذج Pydantic للإيصال الإلكتروني مطابقة لـ ETA Receipt Schema v1.2
  - [ ] تكامل OAuth2 مع بيئات Preprod و Production
  - [ ] تقديم فاتورة تجريبية إلى Preprod والحصول على UUID
  - [ ] جلب حالة الفاتورة تلقائياً
  - [ ] تحقق Pydantic يمنع تقديم فواتير غير مكتملة
  - [ ] جدولة تقديم الدفعات تعمل كل ساعة
  - [ ] تنبيهات البريد الإلكتروني تُرسل عند الحاجة
  - [ ] اختبارات نجحت: 50+ اختبار جديد
...
- معايير القبول:
  - [ ] LetMeShip: حساب أسعار، إنشاء شحنة، ملصق، تتبع
  - [ ] SendCloud: حساب أسعار، إنشاء شحنة، ملصق، تتبع، إلغاء
  - [ ] تحقق أبعاد الطرود يعمل
  - [ ] تحقق العناوين وجهات الاتصال يعمل
  - [ ] معالجة الأخطاء تعرض رسائل واضحة
  - [ ] إعادة المحاولة للفشل المؤقت
  - [ ] اختبارات نجحت: 40+ اختبار جديد
...
✅ مكتملة عند:
- [ ] WP-19: ETA Engine منفذ بالكامل
  - [ ] تكامل OAuth2 مع Preprod و Production
  - [ ] تقديم فاتورة حقيقية إلى Preprod والحصول على UUID
  - [ ] جدولة تقديم الدفعات تعمل
  - [ ] تنبيهات البريد الإلكتروني تُرسل
  - [ ] 50+ اختبار جديد نجحت
