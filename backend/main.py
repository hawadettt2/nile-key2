...
from app.routers import auth, shipping, invoice, suppliers, customers, customs, resources, documents, eta, notifications, audit, workflow, digital_export_manager_router, knowledge_graph, trade_intelligence, dashboard, search, users_router, roles_router, research, export_readiness, architecture_explorer, avatar_ws
...
app.include_router(export_readiness.router)
app.include_router(architecture_explorer.router)
