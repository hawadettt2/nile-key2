...
class MoaahApiClient:
    ...
    def __init__(self, base_url: str, api_key: Optional[str] = None, timeout_seconds: float = 10.0, credential_store: Optional[CredentialStore] = None) -> None:
        ...
        if credential_store is not None:
            credential = credential_store.get("moaah_api_key")
